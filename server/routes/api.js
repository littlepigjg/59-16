...
router.get('/types', (req, res) => {
  res.json({
    ...
    data: {
      ...
      formats: [
        { value: 'chineseName', label: '中文名', category: '文本' },
        { value: 'englishName', label: '英文名', category: '文本' },
        { value: 'email', label: '邮箱', category: '文本' },
        { value: 'phone', label: '手机号', category: '文本' },
        { value: 'idCard', label: '身份证号', category: '文本' },
        { value: 'address', label: '地址', category: '文本' },
        { value: 'company', label: '公司名', category: '文本' },
        { value: 'title', label: '职位', category: '文本' },
        { value: 'sentence', label: '句子', category: '文本' },
        { value: 'paragraph', label: '段落', category: '文本' },
        { value: 'url', label: '网址', category: '文本' },
        { value: 'ip', label: 'IP地址', category: '文本' },
        { value: 'uuid', label: 'UUID', category: '文本' },
        { value: 'custom', label: '自定义正则', category: '文本' },
        { value: 'imageJpeg', label: 'JPEG图片', category: '图片' },
        { value: 'imagePng', label: 'PNG图片', category: '图片' },
        { value: 'imageGif', label: 'GIF图片', category: '图片' },
        { value: 'imageBmp', label: 'BMP图片', category: '图片' },
        { value: 'imageWebp', label: 'WebP图片', category: '图片' },
        { value: 'imageSvg', label: 'SVG矢量图', category: '图片' },
        { value: 'pdf', label: 'PDF文档', category: '文档' },
        { value: 'docx', label: 'Word文档', category: '文档' },
        { value: 'xlsx', label: 'Excel表格', category: '文档' },
        { value: 'zip', label: 'ZIP压缩包', category: '压缩' },
        { value: 'gzip', label: 'GZIP压缩', category: '压缩' },
        { value: 'audioMp3', label: 'MP3音频', category: '音频' },
        { value: 'audioWav', label: 'WAV音频', category: '音频' },
        { value: 'videoMp4', label: 'MP4视频', category: '视频' },
        { value: 'binary', label: '原始二进制', category: '其他' }
      ],
      binaryFormats: [
        'imageJpeg', 'imagePng', 'imageGif', 'imageBmp', 'imageWebp', 'imageSvg',
        'pdf', 'docx', 'xlsx', 'zip', 'gzip',
        'audioMp3', 'audioWav', 'videoMp4', 'binary'
      ]
    }
  });
});
